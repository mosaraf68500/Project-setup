...
const Login = () => {
  ...
  return (
    <div className="w-full mx-auto mt-10 max-w-md p-8 space-y-3 rounded-xl bg-[#050a30] text-white">
      ...
      <form onSubmit={handeSignInForm} className="space-y-6">
        ...
        <div className="w-full">
          <button className="relative cursor-pointer inline-block w-full h-12 text-lg group">
