  ...
  return (
    <div className="w-full mx-auto mt-10 max-w-md p-8 space-y-3 rounded-xl bg-[#050a30] text-white">
      ...
      <form onSubmit={handeSignUpForm} className="space-y-6">
        ...
        {/* <button className="block w-full p-3 text-center rounded-sm bg-gray-300">
          Sign Up
        </button> */}
        <div className="w-full">
          <button
            ...
            className="relative cursor-pointer inline-block w-full h-12 text-lg group"
          >
            <span className="relative z-10 block w-full h-full px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
              <span className="absolute inset-0 w-full h-full rounded-lg bg-gray-50"></span>
              <span className="absolute left-0 w-100 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-gray-900 group-hover:-rotate-180 ease"></span>
